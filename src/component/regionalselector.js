...
import '../css/regionalselector.less';
...
var RegionalSelector = React.createClass({
    ...
    render() {
        return (
            <div className="regional_sel_outer_div">
                ...
                <div className={"regional_sel_inner_div5"+(this.state.active?'':'_change')}>
                    ...
                    {data1.map(function (pro,i) {
                        return(
                        <div className="regional_sel_inner2_div1" key={i} style={{left:10+i%4*65,top:10+Math.floor(i/4)*35}}>

                            <span className="regional_sel_span" title={pro.proId} key={i} onClick={this.selectedProv.bind(this,i)}>
                                {pro.proName}
                            </span>
                        </div>
